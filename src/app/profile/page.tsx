      ...
      <div className="grid h-screen sm:h-screen md:flex">
        ...
        <div className="w-screen flex-1 flex flex-col bg-gray-100">
          ...
          <div className="p-[24px]">
            {" "}
            <div className="bg-white rounded-xl shadow-md p-8 h-screen">
              <div className="text-center items-center py-[50px] md:px-[300px]">
                ...
                <div className="mt-4">
                  <a href="/dashboard">
                    <button className="w-full bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700 transition duration-200">
                      Back To Dashboard
                    </button>
                  </a>
                </div>
