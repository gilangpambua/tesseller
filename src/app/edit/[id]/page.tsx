...
const EditArticle: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchArticle = async () => {
      try {
        const res = await axios.get(
          `${process.env.NEXT_PUBLIC_SELLER}/articles/${id}`
        );
                    ...
                    <div>
                      ...
                      <div className="items-center justify-center">
                        <label
                          ...
                          className="flex flex-col items-center justify-center w-[223px] h-[163px] border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600 relative"
                        >
