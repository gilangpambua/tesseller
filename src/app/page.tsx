...
const LoginForm: React.FC = () => {
  ...
  useEffect(() => {
    console.log("Current role in useEffect:", role);
    if (role) {
      setTimeout(() => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white px-4">
      ...
      <div className="bg-white rounded-xl shadow-md p-8 w-full max-w-sm">
        <div className="flex pb-[20px] justify-center lg:pb-[24px]">
          <svg
            width="134"
            height="24"
            viewBox="0 0 134 24"
          ...
          >
            <g clipPath="url(#clip0_2004_534)">
              ...
              />
              <path
                d="M112.797 7.00067V18.4857H109.861V17.0345C109.486 17.5321 108.993 17.926 108.382 18.2162C107.785 18.4926 107.133 18.6308 106.425 18.6308C105.522 18.6308 104.724 18.4443 104.03 18.0711C103.336 17.6841 102.788 17.1244 102.385 16.3919C101.996 15.6455 101.802 14.761 101.802 13.7383V7.00067H104.717V13.3237C104.717 14.2358 104.946 14.9407 105.404 15.4382C105.863 15.922 106.487 16.1638 107.278 16.1638C108.084 16.1638 108.715 15.922 109.174 15.4382C109.632 14.9407 109.861 14.2358 109.861 13.3237V7.00067H112.797Z"
                fill="#000150"
              />
              <path
              ...
              />
              <path
                d="M29.2669 16.1846H34.0567V18.4857H26.3514V4.01544H29.2669V16.1846Z"
                fill="#000150"
              />
              <path
                d="M47.7725 20.0285C48.511 22.2148 50.5867 23.7896 53.0319 23.7896H53.3362C56.4 23.7896 58.8838 21.3171 58.8838 18.2672V17.9551H55.8761V18.2672C55.8761 19.6637 54.739 20.7957 53.3362 20.7957H53.0319C52.317 20.7957 51.671 20.5017 51.2095 20.0285H47.7725Z"
                fill="#000150"
              />
            </g>
            <defs>
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full appearance-none border border-gray-300 rounded-md px-3 py-2 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600"
            />
          </div>
          <div className="mb-6 relative">
            ...
            <input
              ...
              className="w-full appearance-none border border-gray-300 rounded-md px-3 py-2 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600 pr-10"
            />
            <button
              type="button"
          ...
          <button
            type="submit"
            className="w-full bg-blue-600 hover:bg-blue-700 rounded-md py-3 text-white font-semibold focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-blue-500 mb-4 transition-colors"
          >
            Login
          </button>
        </form>
